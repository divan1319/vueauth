<template>
    <form>
        ...
        <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
            <label><input class="uk-checkbox" type="checkbox"> Acepto los terminos y
                condiciones</label>
        </div>
        <div class="uk-margin">
            <button class="uk-button uk-button-primary uk-button-large uk-width-1-1">Registrarme</button>
        </div>
        <div class="uk-text-small uk-text-center">
            ¿Ya tienes una cuenta? <a href="#" uk-switcher-item="1">Iniciar Sesión</a>
        </div>
    </form>
</template>
